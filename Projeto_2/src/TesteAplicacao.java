...
public class TesteAplicacao {
	...
	public static void main(String[] args) {
		...
		dao.adiciona(new Contato("Carlos", "cedmenezes@gmail.com", "XYZ", "01/06/1981"));
		dao.adiciona(new Contato("Bianca", "bia@gmail.com", "ABC", "03/04/2005"));
		...
		Contato contato = new Contato("Bianca da Silva Santos", "bia@gmail.com", "Rua ABC, 72 - casa 3", "03/04/2005");
		contato.setId(2L);
